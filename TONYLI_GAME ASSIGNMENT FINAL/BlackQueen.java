...
public class BlackQueen extends ChessPiece {
    ...
    private ImageIcon blackQueen = new ImageIcon("PieceImages/blackQueen.png");
    private ImageIcon blackTargetQueen = new ImageIcon("PieceImageTarget/blackQueen.png");
    public BlackQueen(){
        black();
        this.type = "blackQueen";
    }

    @Override
    public void myMove() {for(int i = this.getRow(); i >= 0; i--){ //First part of the vertical
